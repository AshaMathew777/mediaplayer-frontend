...
function VideoCard({displayVideo, setDeleteVideoStatus,isPresent}) {
  ...
  return (
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe width="100%" height="514" src={`${displayVideo?.url}?autoplay=1`} title="Hum Pagal Nahin Hai | Saif Ali Khan &amp; Riteish Deshmukh | Himesh Reshammiya | Humshakals | Lyrical" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </Modal.Body>
